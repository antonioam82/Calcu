...
Button(Calculadora,text=',',bg='gray30',fg='white',width=5).place(x=69,y=401)
Button(Calculadora,text='(',bg='gray30',fg='white',width=5).place(x=133,y=401)
Button(Calculadora,text=')',bg='gray30',fg='white',width=5).place(x=197,y=401)
