...
buttons4.add("(",fg='white',bg='gray30')
buttons4.add(")",fg='white',bg='gray30')
buttons4.add("/",bg='steelblue1',fg='white')
...
buttons5.add("x",bg='steelblue1',fg='white')
...
buttons6.add("-",bg='steelblue1',fg='white')
...
buttons7.add("+",bg='steelblue1',fg='white')
...
buttons8.add("(-)",bg='gray50',fg='white')
buttons8.add("Enter",bg='steelblue1',fg='white')
